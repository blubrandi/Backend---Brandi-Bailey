...
exports.up = function (knex, Promise) {
    return knex.schema
        ...
        .createTable("requests", tbl => {
            ...
            tbl.string("volunteer_assigned").unsigned().references("id").inTable("users").onDelete("RESTRICT").onUpdate("CASCADE")
            tbl.string("business_requesting").unsigned().references("id").inTable("users").onDelete("RESTRICT").onUpdate("CASCADE")
